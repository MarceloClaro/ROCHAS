...
def main():
    ...
    if os.path.exists('capa.png'):
        st.image('capa.png', width=100, caption='Laboratório de Educação e Inteligência Artificial - Geomaker. "A melhor forma de prever o futuro é inventá-lo." - Alan Kay', use_container_width='always')
    else:
  ...
  #___________________________________________________________
    ...
    mp3_files = {
        ...
        "Áudio explicativo para treinamentos de poucos dados": "geografo.mp3",
    }
